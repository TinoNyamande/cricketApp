...
import { Box, Button, CircularProgress, TextField, Typography, Modal, Divider } from "@mui/material";
                ...
                <div className="col-md-12 login-container">
                    <form>
                        ...
                        <Box sx={{ display: "flex", alignItems: "flex-end", margin: "5%" }}>
                            ...
                            <TextField type="password" name="password" value={inputs.password} onChange={handleChange} sx={{ input: { color: "white" }, label: { color: "white" } }}
